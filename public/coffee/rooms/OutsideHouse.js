...
export class OutsideHouse extends Room {
    ...
    initializeRoom(stateReader, objects) {
        ...
        objects.push(new StaticObject("OutsideHouse-Sign", "Sign", "It says: \"This game is powered by the Berra.js adventure game system, written by Vincent van der Leun.\". \"Good to\", you think by yourself."));
    }
